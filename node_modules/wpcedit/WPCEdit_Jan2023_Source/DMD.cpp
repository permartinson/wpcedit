			...
			switch ((*Ptr++) & 0xFF)
			{
				case 0xBE :
						...
						(((*(Ptr+12) & 0xFF) == 0xBD) || ((*(Ptr+12) & 0xFF) == 0xF6)))
					{
...
#if 1 // For t-2 hack temporarily remove this
						...
						if (GetROMAddressFromAddrOf3ByteWPCAddrPage(HitTablePtr, &RomAddr) != 0)
						{
							TmpStr.Format("Error from GetROMAddressFromAddrOf3ByteWPCAddrPage(), Passed it hard-coded: $%02x %02x",(*HitTablePtr)&0xFF,(*(HitTablePtr+1))&0xFF);
							DebugShiftKeyMsgStrPrint(TmpStr);
							return -1;
						}
#endif
