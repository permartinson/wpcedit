...
#define APPLICATION_COPYRIGHT "Copyright (c) 2012"
...
//       all WPC Roms.
//
// v2.1  Putting in code to place DMD frame contents into clipboard.  User can click
//       on the title box to the right of the desired DMD frame to choose it as the
//       frame to put into clipboard.  (April 2012)
